...
namespace Com.Ntt.Skyway.Core.Channel {
	...
	public partial interface ISubscription : IJavaObject, IJavaPeerable {
		global::Com.Ntt.Skyway.Core.Channel.IChannel Channel {
			...
			[Register ("getChannel", "()Lcom/ntt/skyway/core/channel/Channel;", "GetGetChannelHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Content.Stream.ContentType ContentType {
			...
			[Register ("getContentType", "()Lcom/ntt/skyway/core/content/Stream$ContentType;", "GetGetContentTypeHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		string Id {
			...
			[Register ("getId", "()Ljava/lang/String;", "GetGetIdHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		long NativePointer {
			...
			[Register ("getNativePointer", "()J", "GetGetNativePointerHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		global::Kotlin.Jvm.Functions.IFunction0? OnCanceledHandler {
			...
			[Register ("getOnCanceledHandler", "()Lkotlin/jvm/functions/Function0;", "GetGetOnCanceledHandlerHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
			...
			[Register ("setOnCanceledHandler", "(Lkotlin/jvm/functions/Function0;)V", "GetSetOnCanceledHandler_Lkotlin_jvm_functions_Function0_Handler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			set; 
		}
		...
		global::Kotlin.Jvm.Functions.IFunction1? OnConnectionStateChangedHandler {
			...
			[Register ("getOnConnectionStateChangedHandler", "()Lkotlin/jvm/functions/Function1;", "GetGetOnConnectionStateChangedHandlerHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
			...
			[Register ("setOnConnectionStateChangedHandler", "(Lkotlin/jvm/functions/Function1;)V", "GetSetOnConnectionStateChangedHandler_Lkotlin_jvm_functions_Function1_Handler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			set; 
		}
		...
		string PreferredEncodingId {
			...
			[Register ("getPreferredEncodingId", "()Ljava/lang/String;", "GetGetPreferredEncodingIdHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Channel.IPublication Publication {
			...
			[Register ("getPublication", "()Lcom/ntt/skyway/core/channel/Publication;", "GetGetPublicationHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Content.WebRTCStats? Stats {
			...
			[Register ("getStats", "()Lcom/ntt/skyway/core/content/WebRTCStats;", "GetGetStatsHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Content.Remote.RemoteStream? Stream {
			...
			[Register ("getStream", "()Lcom/ntt/skyway/core/content/remote/RemoteStream;", "GetGetStreamHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		global::Com.Ntt.Skyway.Core.Channel.Member.IMember Subscriber {
			...
			[Register ("getSubscriber", "()Lcom/ntt/skyway/core/channel/member/Member;", "GetGetSubscriberHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
			get; 
		}
		...
		[Register ("cancel", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "GetCancel_Lkotlin_coroutines_Continuation_Handler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
		...
		[Register ("changePreferredEncoding", "(Ljava/lang/String;)V", "GetChangePreferredEncoding_Ljava_lang_String_Handler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
		...
		[Register ("getState", "()Lcom/ntt/skyway/core/channel/Subscription$State;", "GetGetStateHandler:Com.Ntt.Skyway.Core.Channel.ISubscriptionInvoker, core_skyway")]
