...
namespace Com.Ntt.Skyway.Core.Content.Sink {
	...
	public partial interface IRenderer : IJavaObject, IJavaPeerable {
		bool Setup {
			...
			[Register ("isSetup", "()Z", "GetIsSetupHandler:Com.Ntt.Skyway.Core.Content.Sink.IRendererInvoker, skyway-core")]
			get; 
			...
			[Register ("setSetup", "(Z)V", "GetSetSetup_ZHandler:Com.Ntt.Skyway.Core.Content.Sink.IRendererInvoker, skyway-core")]
			set; 
		}
		...
		[Register ("dispose", "()V", "GetDisposeHandler:Com.Ntt.Skyway.Core.Content.Sink.IRendererInvoker, skyway-core")]
		void Dispose ();
