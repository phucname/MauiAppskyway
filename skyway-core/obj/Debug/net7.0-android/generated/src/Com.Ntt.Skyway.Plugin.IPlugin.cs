...
namespace Com.Ntt.Skyway.Plugin {
	...
	public partial interface IPlugin : IJavaObject, IJavaPeerable {
		string Name {
			...
			[Register ("getName", "()Ljava/lang/String;", "GetGetNameHandler:Com.Ntt.Skyway.Plugin.IPluginInvoker, skyway-core")]
			get; 
		}
		...
		[Register ("createRemoteMember", "(Lcom/ntt/skyway/core/channel/member/Member$Dto;)Lcom/ntt/skyway/core/channel/member/RemoteMember;", "GetCreateRemoteMember_Lcom_ntt_skyway_core_channel_member_Member_Dto_Handler:Com.Ntt.Skyway.Plugin.IPluginInvoker, skyway-core")]
